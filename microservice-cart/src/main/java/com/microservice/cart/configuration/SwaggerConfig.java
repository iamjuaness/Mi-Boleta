package com.microservice.cart.configuration;
...
@OpenAPIDefinition(
        info = @Info(
                title = "API MANAGE CART",
                description = "This microservice provides the necessary methods that have to do with cart logic, " +
